        ...
        public bool InitialCapital()
        {
            ...
            try
            {
                if (CAPCenter == null)
                {
                    ...
                    MainForm.DataGridOrderDetail.Columns[StrategyData.PropertyMap[nameof(StrategyData.StopWinPriceAfter)].Item1.WPFDisplayIndex].Visibility = System.Windows.Visibility.Collapsed;
