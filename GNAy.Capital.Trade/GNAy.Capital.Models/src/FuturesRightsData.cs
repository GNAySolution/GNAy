...
namespace GNAy.Capital.Models
{
    ...
    public class FuturesRightsData : NotifyPropertyChanged
    {
        ...
        public FuturesRightsData(string raw, [CallerMemberName] string memberName = "")
        {
            ...
            F0 = decimal.Parse(cells[0]);
            F1 = decimal.Parse(cells[1]);
            F2 = decimal.Parse(cells[2]);
            F3 = decimal.Parse(cells[3]);
            F4 = decimal.Parse(cells[4]);
            F5 = decimal.Parse(cells[5]);
            F6 = decimal.Parse(cells[6]);
            F7 = decimal.Parse(cells[7]);
            F8 = decimal.Parse(cells[8]);
            F9 = decimal.Parse(cells[9]);
            F10 = decimal.Parse(cells[10]);
            F11 = decimal.Parse(cells[11]);
            F12 = decimal.Parse(cells[12]);
            F13 = decimal.Parse(cells[13]);
            F14 = decimal.Parse(cells[14]);
            F15 = decimal.Parse(cells[15]);
            F16 = decimal.Parse(cells[16]);
            F17 = decimal.Parse(cells[17]);
            F18 = decimal.Parse(cells[18]);
            F19 = decimal.Parse(cells[19]);
            F20 = decimal.Parse(cells[20]);
            F21 = decimal.Parse(cells[21]);
            F22 = decimal.Parse(cells[22]);
            F23 = cells[23].Trim();
            F24 = decimal.Parse(cells[24]);
            Currency = cells[25].Trim();
            F26 = decimal.Parse(cells[26]);
            F27 = decimal.Parse(cells[27]);
            F28 = decimal.Parse(cells[28]);
            F29 = decimal.Parse(cells[29]);
            F30 = decimal.Parse(cells[30]);
            F31 = decimal.Parse(cells[31]);
            F32 = decimal.Parse(cells[32]);
            F33 = decimal.Parse(cells[33]);
            F34 = decimal.Parse(cells[34]);
            F35 = decimal.Parse(cells[35]);
            F36 = decimal.Parse(cells[36]);
            F37 = decimal.Parse(cells[37]);
            F38 = decimal.Parse(cells[38]);
