#ifndef _TOOLS_IL01_CRC32_H
#define _TOOLS_IL01_CRC32_H
...
namespace Tools
{
    static constexpr unsigned int CRCBaseTable[256] =
    {
    ...
    struct MM
    {
        ...
        {
            return MM<Size, Idx + 1>::CRC32(str, (prev_crc >> 8) ^ CRCBaseTable[(prev_crc ^ str[Idx]) & 0xFF]);
        }
    };
    ...
    static constexpr unsigned int CRCEmpty = CRC2INT("");
    static constexpr bool ChkCRCEmpty = CRCEmpty == 0x00000000;

    static constexpr unsigned int CRCSpace = CRC2INT(" ");
    static constexpr bool ChkCRCSpace = CRCSpace == 0xE96CCF45;

    static constexpr unsigned int CRC1 = CRC2INT("1");
    static constexpr bool ChkCRC1 = CRC1 == 0x83DCEFB7;

    static constexpr unsigned int CRC123456789 = CRC2INT("123456789");
    static constexpr bool ChkCRC123456789 = CRC123456789 == 0xCBF43926;

    static constexpr unsigned int CRCCrcVal01 = CRC2INT("CrcVal01");
    static constexpr bool ChkCRCCrcVal01 = CRCCrcVal01 == 0xCC3B0811;

    static constexpr unsigned int CRCFilePath = CRC2INT(__FILE__);
    static constexpr bool ChkCRCFilePath = CRCFilePath == 0xB413D6BF;
